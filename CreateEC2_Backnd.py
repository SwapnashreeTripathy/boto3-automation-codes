...
instances = ec2_resource.create_instances(
        ...
        UserData='''#!/bin/bash
                ...
                cd /home/ubuntu/
                sudo git clone https://github.com/SwapnashreeTripathy/Deploy_MERNapp_onAWS_EC2Server.git
                cd /home/ubuntu/Deploy_MERNapp_onAWS_EC2Server/backend/
                sudo npm install
                echo 'MONGO_URI="mongodb+srv://swapnashreet95:VOtxVo6jXyaKXboI@devops.mnvxfkr.mongodb.net/travel_mern"' >> .env
                echo 'PORT=80' >> .env
